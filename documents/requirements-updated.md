...
This requirements list reflects the implemented Prodact demo in this repository. It scopes the project to the current Next.js internal tool, employee authentication, seeded Target product data, heuristic recommendations, protected app pages, and demo-ready dashboards.
...
| FR-5 | Dashboard overview | The system shall provide a `/dashboard` page summarizing the final demo services and linking to evidence routes. | Hadent |
| FR-6 | Navigation tabs | The system shall provide sidebar tabs for Dashboard, Store Performance, Inventory, Competitor Analysis, Product Analysis, Notifications, AskProdact, Store Layout, and Settings. | Hadent |
...
| FR-29 | AskProdact page | The system shall provide an AskProdact page for database-grounded product, inventory, route, and demo questions. | Sangeetha |
...
| FR-31 | Assistant API | The system shall include an API route for answering AskProdact questions with Gemini or deterministic fallback logic. | Hasnain |
